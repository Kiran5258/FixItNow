...
import UsersCardHome from "./components/Admin/UsersCardHome";
...
>
  <span className="text-lg transition-transform duration-300 hover:rotate-6">{item.icon}</span>
  <span>{item.name}</span>
</button>
...
// The detailed UI components (MetricCard, UsersCardHome, BookingsCard, UsersCardFull,
// ServicesCardFull, AdminChatSection, VerifyDocumentsTab) were split into separate files
// under the `./components` folder to keep this file concise.